...
class DeprecatedVideoUploadUrlTests(BaseAuthenticatedTests):
    """
    TODO remove these test cases once we have gotten rid of the VideoUploadViewset class.
    """

    def setUp(self):
        super(DeprecatedVideoUploadUrlTests, self).setUp()
